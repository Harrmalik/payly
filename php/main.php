    ...
    case 'GET':
      switch ($_REQUEST['module']) {
        ...
        case 'getManager':
            ...
            break;
        case 'admin':
            $response = doGetRequest($NodeServer . "/admin?action=" . $_REQUEST['action'] . "&empid=" . $_REQUEST['empid'] . "&startDate=" . $_REQUEST['startDate'] . "&endDate=" . $_REQUEST['endDate'] . "&report=" . $_REQUEST['report'], $username, $password);
            break;
      }
